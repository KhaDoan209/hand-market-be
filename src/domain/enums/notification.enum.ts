...
export enum NotificationContent {
   ...
   ORDER_RECEIVED = "Đơn hàng của bạn đã được lấy và bắt đầu vận chuyển",
   ORDER_DONE = "Khách hàng đã nhận được đơn hàng của bạn",
   ...
   SHIPMENT_OUT_FOR_DELIVERY = "Đơn hàng đã tìm được shipper và đang được chuẩn bị.",
   ...
   SHIPMENT_DELIVERED = "Chúc mừng! Đơn hàng của bạn đã được giao thành công.",
